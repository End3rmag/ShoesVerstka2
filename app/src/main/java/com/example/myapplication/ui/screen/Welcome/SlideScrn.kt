...
fun SlidesScrn(
    ...
    val pages = listOf(
        ...
        OnboardingPage(
            welcome = "",
            title = stringResource(R.string.start_travaling),
            description = stringResource(R.string.opisanie_travaling),
            image = R.drawable.sneacker,
            image2 = R.drawable.curlicues
        ),
        OnboardingPage(
            welcome = "",
            title = stringResource(R.string.start_travaling_2),
            description = stringResource(R.string.opisanie_travaling_2),
